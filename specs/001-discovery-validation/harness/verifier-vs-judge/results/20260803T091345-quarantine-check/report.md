...
- NOT RUN  **predicted-null (c1)** — NOT RUN — arm (c1) is quarantined (Amendment B5) and produced no verdict, so there is nothing to test the prediction against. S3 is neither satisfied nor violated; it is undischarged.
