...
Recovered verbatim from /tmp/f2a-probe-runtime/probe_adk_strict.py on 2026-08-02.
Produces the structured-output column of finding 003's ADK matrix, and result 5.
See the README.
"""
import asyncio
import json
