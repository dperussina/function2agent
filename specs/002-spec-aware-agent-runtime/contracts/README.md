...
|---|---|---|
| [`configuration.md`](./configuration.md) | how configuration reaches the runtime, what is required, and what fails loudly | FR-032, FR-033, FR-043, FR-049 |
| [`egress-policy.md`](./egress-policy.md) | exactly what the single enforcement point accepts and denies, and how a denial is recorded | FR-008–FR-019, FR-021, FR-050 |
| [`result-record.md`](./result-record.md) | the caller-visible verification contract | FR-025, FR-026, FR-045, FR-047, FR-052 |
| [`trace-record.md`](./trace-record.md) | span shape, and the pinning terms a measurement artifact must carry | FR-005, FR-011, FR-030, FR-053 |
| [`artifact-versioning.md`](./artifact-versioning.md) | canonical form, content addressing, rollback | FR-027, FR-028, FR-034, FR-054 |
