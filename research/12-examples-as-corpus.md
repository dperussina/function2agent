...
- **`src/db/schema.sql`** — four tables. Per `06`, the SQLite file is the most important extension point for a polyglot product: queryable from Python, Go, anything. **Design against the schema, not the TypeScript API.**
